...
import java.util.Scanner;
        public class Tugas2_aulia {

    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        Scanner sc = new Scanner(System.in);
        Integer pilihan = 0;
        int harga_item[] = {20000, 25000, 30000, 23000};
        String menu = null;
        int pembayaran;
        ...
        System.out.println("-------------------------------------------------");   
        System.out.println("| 1. Americano                |   Rp 20000      |");
        System.out.println("| 2. Arabika                  |   Rp 25000      |");
        System.out.println("| 3. Latte                    |   Rp 30000      |");
        System.out.println("| 4. Matcha                   |   Rp 23000      |");
